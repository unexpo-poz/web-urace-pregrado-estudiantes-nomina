...
if ($inscHabilitada){
	...
	print <<<x001
		...
		Disculpe, el proceso se cerró el día 06/06/2018.
		</div><br>
x001
;
}
   ...
   <!--  <tr><td> class ="instruc" style="padding-left:10px;padding-top:10px;" ><b>NOTAS:</b>
	...
	<td class ="instruc" width="15%">&nbsp;</td>
      ...
      <ul style="padding-right:25px;text-align:justify;">
	       <li>La página estará habilitada segun calendario programado por BIENESTAR Estudiantil   </li>
           <li>No olvide cargar asistencia, sino lo realizas este proceso a tiempo no obtendras el pago   </li>
