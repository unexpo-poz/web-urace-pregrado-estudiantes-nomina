...
$conex2 = new ODBC_Conn('helpdesk','sysadm','francia',TRUE,'aprobacion_benef.log');
...
require_once("inc/odbcss_c.php");
$conex = new ODBC_Conn("$basededatos","$usuariodb","$clavedb",TRUE,"$laBitacora");
$mSQL  = "select NOMBRES,APELLIDOS,SEMESTRE,NRO_CTA,C_UNI_CA,TIPO_CTA,TIPO,NOMBRES2,APELLIDOS2,TELEFONO1,CORREO1,exp_e from DACE002 a, AYU_CUENTA b,AYU_ESTUDIANTES d where a.CI_E='$validar' and ";
...
$SQLxx = "SELECT dependencia FROM ayu_sol_beneficio where exp_e='".$exp."' and lapso='".$lapsoProceso."'";
//echo $SQLxx;
$conex->ExecSQL($SQLxx,__LINE__,true);
$resulxx = $conex->result;
$depenx=$resulxx[0][0];
//echo 'aqui'.$depenx;
$SQLxx = "SELECT  depart FROM departamentos where codigo_depto='".$depenx."' ORDER BY 1";
//echo $SQLxx;
$conex2->ExecSQL($SQLxx,__LINE__,true);
$resulxx = $conex2->result;
$depen2=$resulxx[0][0];
//echo 'aqui'.$depen2;
...
numero = numero + 1;
	...
	newCell2.innerHTML = 'Dia del mes:&nbsp;&nbsp;<input type="text" name="fechas'+fila+'" id="fechas'+fila+'" size="10" maxlength="2" onKeyUp="fecha30()"  style=" font-size:12px;font-family:Arial" >'; // Second cell's innerHTML

	var newCell3 = newRow.insertCell(2); // Insert the second cell
	newCell3.innerHTML = ''; // Second cell's innerHTML
	var newCell4 = newRow.insertCell(3); // Insert the second cell
	newCell4.innerHTML = ''; // Second cell's innerHTML
...
<!--
  ...
  function planilla_open(f) {
	...
	if (document.getElementById("dependencia").value=="" || document.getElementById("supervisor").value=="")
	 {
	 ...
	 <tr><td>
		...
		<table border="0px" align="center" width="830">
		  ...
		  <tr>
			  ...
			  <tr>
			  <td><input type=text name='dependencia' size="30" id="dependencia" class="datospf" maxlength="30" value="<?php echo $depen2; ?>"></td>
		...
		<td width="491">Actividades Realizadas:</td>
		<td width="116">Dia:</td>
		<td width="1"> &nbsp;</td>
		<td width="1"> &nbsp;</td>
		<td width="38">Nro:</td>
...
<table width="800" class="re" id="thetable" valign="top">
	<tr>
		<td colspan="5" align="center">
			<input name="button_enviar" type="button" class="boton"  onClick="InsertRow()" value="A&ntilde;adir Fila" />
			<input type="button" value="Borrar Fila" class="boton" onClick="removeRow()"/>
		</td>
	</tr>
...
<table width="179" align="center">
	<tr>
		<td width="171" class="datosp">
			<input style="font-size: 10px"  type="hidden" disabled="disabled" id="boton" name="enviar2"  class="boton" value="Aplicar"   > 
		    <input style="font-size: 12px"  type="button" class="boton" value="Guardar" onClick="planilla_open(this.form) &&  ValidaCampos(this)">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="font-size: 12px"  type="button" class="boton" value="Ver Planilla" onClick="ver_planilla()">
		</td>
	</tr>
</table>
