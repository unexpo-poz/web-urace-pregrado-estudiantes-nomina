...
for($k=1;$k<=$N;$k++) {
	...
	@$fechas[$k] = substr("0".$fechas[$k],-2);

	$mSQL30 = "INSERT INTO ASISTENCIAS ";
	$mSQL30.= "(CODIGO,CI_E,FECHA_LAP_INI,FECHA_LAP_FIN,DEPENDENCIA,NOM_SUPERVISOR,LAPSO,ACT_REALIZADA,FECHA,MES,RETRASADOS,NRO) VALUES ";
	$mSQL30.= "('$COD','$CEDULA1','$FECHA','$FECHA1','$DEPENDENCIA','$SUPERVISOR','$LAPSO1','$ACT[$k]','$fechas[$k]','$mes', '$normal', '$numero[$k]') " ;	
